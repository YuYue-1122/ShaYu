...
namespace YiSha.Data.Repository
{
    ...
    public class Repository
    {
        ...
        {
            return await db.FindTopListOrderBy<T>(condition, orderby, top, sortType);
        }
        ...
        {
            return await db.FindTopList<T>(strSql, dbParameter, top);
        }
        #endregion
