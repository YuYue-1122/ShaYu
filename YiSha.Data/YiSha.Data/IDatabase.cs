...
namespace YiSha.Data
{
    public interface IDatabase
    {
        ...
        Task<IEnumerable<T>> FindListOrderBy<T>(Expression<Func<T, bool>> condition, Func<T, object> orderby) where T : class, new();
        Task<IEnumerable<T>> FindTopList<T>(Expression<Func<T, bool>> condition, int top) where T : class, new();
        Task<IEnumerable<T>> FindTopListOrderBy<T>(Expression<Func<T, bool>> condition, Func<T, object> orderby, int top, string sortType) where T : class, new();
        Task<IEnumerable<T>> FindTopList<T>(string strSql, DbParameter[] dbParameter, int top) where T : class;
