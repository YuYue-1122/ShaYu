...
namespace YiSha.Entity
{
    ...
    public class NewBaseCreateEntity : NewBaseEntity
    {
        /// <summary>
        /// 创建时间
        /// </summary>
    ...
    public class NewBaseModifyEntity : NewBaseCreateEntity
    {
        /// <summary>
        /// 数据更新版本，控制并发
        /// </summary>
    ...
    public class NewBaseExtensionEntity : NewBaseModifyEntity
    {
        /// <summary>
        /// 是否删除 1是，0否
        /// </summary>
